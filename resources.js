...
var resources = [{
    ...
    description: "Support for caregivers of children with disabilities; Autism Spectrum Disorder education and resources, parent and mental health support, support groups for families and parents. ", //brief description
  ...
  },
  {
    ...
    description: "Autism information and support groups, IEP parent partner program, special education assistance and resources, groups for parents raising children with disabilities and Autism, sibling support program, self-advocacy training, independent living skills.", //brief description
  ...
  },
  {
    ...
    hierarchy: ["00"],
    tags: ["Legal", "Autism Advocacy", "IEP", "504 Plan"], //array of string tags
    isActive: true, //True/False
    dateAdded: "9/30/2019",
    whoAdded: "Whitney"
  },
  {
    ...
    description: "Special education resources categorized in four sections: general special education resources, dispute resolution information, lawyer referrals, specialized education resources.", //brief description
    website: "https://www.disabilityrightswa.org/publications/special-education-resources/", //url to website
    ...
    location: "Seattle, WA", //general location
    hierarchy: ["00"],
    tags: ["Legal", "educational rights", "special education"], //array of string tags
    isActive: true, //True/False
    dateAdded: "9/30/2019",
    whoAdded: "Whitney"
  },
  {
    ...
    description: "Information about and application for SSI disability benefits for children.  Printable booklet and checklists available.", //brief description
    website: "https://www.ssa.gov/disability/disability_starter_kits_child_eng.htm", //url to website
    ...
    location: "", //general location
    hierarchy: ["00"],
    tags: ["Disability", "social security", "SSI application"], //array of string tags
    isActive: true, //True/False
    dateAdded: "9/30/2019",
    whoAdded: "Whitney"
  },
  {
    ...
    description: "Eligibility information for special services, family and individual supports, service provider information, respite services, employment and independence skills help.", //brief description
    ...
    hierarchy: ["00"],
    tags: ["Disability"], //array of string tags
    isActive: true, //True/False
    dateAdded: "9/30/2019",
    whoAdded: "Whitney"
  },
  {
    ...
    hierarchy: ["00"],
    tags: ["Disability", "family support", "early intervention", "life transitions"], //array of string tags
    isActive: true, //True/False
    dateAdded: "9/30/2019",
    whoAdded: "Whitney"
  },
  {
    ...
    description: "Provides public policy recommendations, works to address service gaps, provides disability advocacy, schedules council meetings, advises Governor.", //brief description
  ...
  },
  {
    ...
    description: "Register athletes, develop leadership skills, compete in different sports, community connections and support.", //brief description
    ...
    location: "Seattle, WA", //general location
    hierarchy: ["00"],
    tags: ["Special Olympics", "disability", "sports"], //array of string tags
    isActive: true, //True/False
    dateAdded: "9/30/2019",
    whoAdded: "Whitney"
  },
  {
    id: "10", //int
    organization: "National Consortium on Leadership & Disability for Youth (NCLD/Y)", //name of organization or title of project
    description: "National youth-led information, training, and resource center; youth leadership development; independent living skill development and support; training development, disability policy analysis. ", //brief description
    ...
    hierarchy: ["00"],
    tags: ["Disability", "disability leadership", "youth leadership"], //array of string tags
    isActive: true, //True/False
    dateAdded: "9/30/2019",
    whoAdded: "Whitney"
  },
  {
    ...
    description: "Project of Disability Rights WA: creates and promotes authenic accessible stories to challenge stigma and redefine narratives around disability, mental health, chronic illness; develop and share stories made by those with disabilities. ", //brief description
  ...
  {
    id: "12", //int
    organization: "Seattle Childrens Hospital Autism Center", //name of organization or title of project
    description: "Assessment, diagnosis, treatment, support for ASD; parent education and support; medication management, pediatric feeding program, speech & language assessment, genetic consultation clinic; referral information and insurance information.", //brief description
    ...
    location: "Seattle, WA", //general location
    hierarchy: ["00"],
    tags: ["Autism", "Autism assessment", "parent support"], //array of string tags
    isActive: true, //True/False
    dateAdded: "9/30/2019",
    whoAdded: "Whitney"
  }
